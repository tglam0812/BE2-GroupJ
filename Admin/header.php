...
include '../Admin/Models/categories.php';
include '../Admin/Models/user.php';
include '../Admin/Models/order.php';
$cate = new Category();
?>
<!doctype html>
...
<head>
    ...
    // Đặt tiêu đề trang dựa trên tên file
    switch ($currentPage) {
        case 'index.php':
            $pageTitle = 'Dashboard';
            break;
    ...
    <meta name="description" content="Khám phá cửa hàng thực phẩm chất lượng hàng đầu với đa dạng sản phẩm tươi ngon, hữu cơ và an toàn cho sức khỏe. Đặt hàng trực tuyến và nhận giao hàng nhanh chóng!">
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="User List" href="user-list.php"><span class="mini-sub-pro">User</span></a></li>
                                <li><a title="Product List" href="product-list.php"><span class="mini-sub-pro">Product</span></a></li>
                                <li><a title="Category List" href="cate-list.php"><span class="mini-sub-pro">Category</span></a></li>
                                <li><a title="Order List" href="order-list.php"><span class="mini-sub-pro">Order</span></a></li>
        ...
        <div class="header-advance-area">
            <div class="header-top-area">
                                                ...
                                                <li class="nav-item">
                                                    <?php if (isset($_SESSION['is_logged_in']) && $_SESSION['is_logged_in']): ?>
                                                        ...
                                                        <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                            ...
                                                            <li><a href="../Source/logout.php"><span class="icon nalika-unlocked author-log-ic"></span> Log Out</a>
                                                            </li>
                                                        </ul>
                                                    <?php else: ?>
                                                        <a href="../Source/login.php"><i class="icon nalika-user nalika-user-rounded header-riht-inf"></i> Đăng nhập</a>
                                                    <?php endif; ?>
                                                </li>
                ...
                <?php if (isset($_SESSION['success'])): ?>
                    <div class="alert alert-success" id="success-message" style="text-align: center; display: flex; justify-content: center; align-items: center; height: 50px;">
                        <?php
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="cate-list.php">Category</a></li>
